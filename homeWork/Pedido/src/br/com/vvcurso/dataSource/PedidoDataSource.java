...
//		pedidos.remove(pedido);
	...
	/** Modo privado para editar o Pedido dada a entrada seja o código de pedido
	  * 
	  */
	...
	/** Remove o pedido dada a entrada passe o código de pedido e uma variável de controle de mensagem
	  * 
	  */
